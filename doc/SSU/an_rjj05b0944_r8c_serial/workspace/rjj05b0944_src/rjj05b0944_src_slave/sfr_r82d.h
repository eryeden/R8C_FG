...
/************************************************************************************
*                                                                                   *
*   File Name   : SFR_R82D.h                                                        *
*   Contents    : definition of R8C/2C & R8C/2D Group SFR                           *
...
#pragma	ADDRESS		ad1_addr		02C2H	/* A-D register 1 */

#pragma	ADDRESS		ad2_addr		02C4H	/* A-D register 2 */

#pragma	ADDRESS		ad3_addr		02C6H	/* A-D register 3 */
...
#pragma	ADDRESS		pd7_addr		02E0H	/* Port P7 direction register */

#pragma	ADDRESS		p7_addr			02E2H	/* Port P7 register */

#pragma	ADDRESS		pd8_addr		02E4H	/* Port P8 direction register */

#pragma	ADDRESS		pd9_addr		02E5H	/* Port P9 direction register */

#pragma	ADDRESS		p8_addr			02E6H	/* Port P8 register */

#pragma	ADDRESS		p9_addr			02E7H	/* Port P9 register */
...
#define		pu20		pur2_addr.bit.b0			/* P70 to P73 pull-up */
#define		pu21		pur2_addr.bit.b1			/* P74 to P77 pull-up */
#define		pu22		pur2_addr.bit.b2			/* P80 to P83 pull-up */
#define		pu23		pur2_addr.bit.b3			/* P84 to P87 pull-up */
#define		pu24		pur2_addr.bit.b4			/* P90 to P93 pull-up */
...
#define		adgsel1		adcon2_addr.bit.b4			/* A-D input group select bit */
...
#define		scan0		adcon1_addr.bit.b0			/* Single sweep mode, Repeat sweep mode, A-D input group select bit */
...
union{
	...
	unsigned int	word;
} u0tb_addr, u1tb_addr, u2tb_addr, ad0_addr, ad1_addr, ad2_addr, ad3_addr;
