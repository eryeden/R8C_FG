...
#define		trbosel		pinsr2_addr.bit.b6		/* Port TRBO enable bit */
...
#define		trciocsel	pinsr3_addr.bit.b3		/* Port TRCIOC enable bit */
#define		trciodsel	pinsr3_addr.bit.b4		/* Port TRCIOD enablet bit */
